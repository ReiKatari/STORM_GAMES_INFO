...
[![Tech](https://img.shields.io/badge/Tech-Python+%2f+REST+APIs+%2f+SQLite-6366F1.svg?style=for-the-badge)](https://github.com/ReiKatari/STORM_GAMES_INFO)
...
**STORM GAMES INFO** — компонент экосистемы **STORM**, разработанный с упором на максимальную производительность, современный дизайн и надёжность.
